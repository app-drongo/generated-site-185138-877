...
// Generated: 2025-08-21T22:42:48.676Z
// Section: page-header
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Discover how our team of experienced attorneys can help your business navigate the complex legal landscape
            and achieve your goals. With over 25 years of expertise, we're dedicated to providing exceptional
