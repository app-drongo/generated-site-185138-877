...
// Generated: 2025-08-21T22:42:48.879Z
// Section: page-header
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            At Thompson & Associates, we offer a wide range of legal services tailored to the unique needs of modern businesses.
            From corporate law to litigation, our experienced team is dedicated to providing strategic guidance and practical solutions to help your company thrive.
          </p>
        </div>
      </div>
    </section>
